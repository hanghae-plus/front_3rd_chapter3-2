import { RepeatType } from '../entities/event/model/type.ts';
import { generateRecurringEvents } from '../features/calendar/lib/dateUtils.ts';

describe('generateRecurringEvents', () => {
  it('매일 반복 > 간격 1, 시작 날짜와 종료 날짜를 포함한다.', () => {
  ...
  it('매주 반복 > 간격 1, 시작 날짜와 종료 날짜를 포함한다.', () => {
  ...
  it('매월 반복 > 간격 1, 시작 날짜와 종료 날짜를 포함한다.', () => {
  ...
  it('매년 반복 > 간격 1, 시작 날짜와 종료 날짜를 포함한다.', () => {
  ...
  it('매일 반복 > 간격 2, 종료 날짜를 초과하지 않고 이전까지 날짜를 포함한다.', () => {
  ...
  it('매월 반복 > 간격 3, 종료 날짜를 초과하지 않고 이전까지 날짜를 포함한다.', () => {
  ...
  it('매주 반복 > 종료 날짜 이전까지 정확하게 반복 일정이 생성된다.', () => {
