...
interface EventFormProps {
  initialEvent: EventFormState;
  onSubmit: (event: EventFormState) => void;
}

export const EventForm = ({ initialEvent, onSubmit }: EventFormProps) => {
  const { formState, errors, handleInputChange, handleCheckboxChange, handleSubmit } = useEventForm(
    initialEvent,
    onSubmit
  );
